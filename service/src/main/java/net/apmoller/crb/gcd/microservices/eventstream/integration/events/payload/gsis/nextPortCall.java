...
public class nextPortCall extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5929910774968888600L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"nextPortCall\",\"namespace\":\"net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis\",\"fields\":[{\"name\":\"cityCode\",\"type\":\"string\"},{\"name\":\"terminalCode\",\"type\":\"string\"},{\"name\":\"cityName\",\"type\":\"string\"},{\"name\":\"terminalName\",\"type\":\"string\"},{\"name\":\"geoCode\",\"type\":\"string\"}],\"connect.name\":\"emp.maersk.com.nextPortCall\"}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<nextPortCall> ENCODER =
      new BinaryMessageEncoder<nextPortCall>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<nextPortCall> DECODER =
      new BinaryMessageDecoder<nextPortCall>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<nextPortCall> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<nextPortCall> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<nextPortCall> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<nextPortCall>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this nextPortCall to a ByteBuffer.
  ...
  /**
   * Deserializes a nextPortCall from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a nextPortCall instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static nextPortCall fromByteBuffer(
   ...
   */
  public nextPortCall(java.lang.CharSequence cityCode, java.lang.CharSequence terminalCode, java.lang.CharSequence cityName, java.lang.CharSequence terminalName, java.lang.CharSequence geoCode) {
  ...
  /**
   * Creates a new nextPortCall RecordBuilder.
   * @return A new nextPortCall RecordBuilder
   */
  public static net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder newBuilder() {
    return new net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder();
  }

  /**
   * Creates a new nextPortCall RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new nextPortCall RecordBuilder
   */
  public static net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder newBuilder(net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder other) {
    if (other == null) {
      return new net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder();
    } else {
      return new net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder(other);
    }
  }

  /**
   * Creates a new nextPortCall RecordBuilder by copying an existing nextPortCall instance.
   * @param other The existing instance to copy.
   * @return A new nextPortCall RecordBuilder
   */
  public static net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder newBuilder(net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall other) {
    if (other == null) {
      return new net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder();
    } else {
      return new net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder(other);
  ...
  /**
   * RecordBuilder for nextPortCall instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<nextPortCall>
    implements org.apache.avro.data.RecordBuilder<nextPortCall> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing nextPortCall instance
     * @param other The existing instance to copy.
     */
    private Builder(net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.cityCode)) {
        this.cityCode = data().deepCopy(fields()[0].schema(), other.cityCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder setCityCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder clearCityCode() {
      cityCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder setTerminalCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder clearTerminalCode() {
      terminalCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder setCityName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder clearCityName() {
      cityName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder setTerminalName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder clearTerminalName() {
      terminalName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder setGeoCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.apmoller.crb.gcd.microservices.eventstream.integration.events.payload.gsis.nextPortCall.Builder clearGeoCode() {
      geoCode = null;
    ...
    public nextPortCall build() {
      try {
        nextPortCall record = new nextPortCall();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<nextPortCall>
    WRITER$ = (org.apache.avro.io.DatumWriter<nextPortCall>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<nextPortCall>
    READER$ = (org.apache.avro.io.DatumReader<nextPortCall>)MODEL$.createDatumReader(SCHEMA$);
